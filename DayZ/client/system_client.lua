...
###----------------#################------------------------###
###--------------- Edit by KopfKrank -----------------------###
###----- Copyright liegt bei Marwin W., Lower Saxony -------###
###------###########################################--------###
]]
...
--SKIN REPLACEMENTS
    local skin = engineLoadTXD ( "peds/22.txd" ) -- slashed 12 by Wall-E
    engineImportTXD ( skin, 22 )    
    local skin = engineLoadTXD ( "peds/56.txd" ) --young and blue by Slothman
    engineImportTXD ( skin, 56 )
    local skin = engineLoadTXD ( "peds/67.txd" ) -- slit r* employee
    engineImportTXD ( skin, 67 )
    local skin = engineLoadTXD ( "peds/68.txd" ) -- shredded preist by Deixell
    engineImportTXD ( skin, 68 )
    local skin = engineLoadTXD ( "peds/69.txd" ) --bleedin eyes in denim by Capitanazop
    engineImportTXD ( skin, 69 )
    local skin = engineLoadTXD ( "peds/70.txd" ) --ultra gory scientist by 50p
    engineImportTXD ( skin, 70 )
    local skin = engineLoadTXD ( "peds/84.txd" ) --guitar wolf (nonzombie) by Slothman
    engineImportTXD ( skin, 84 )
    local skin = engineLoadTXD ( "peds/92.txd" ) -- peeled flesh by xbost
    --[[engineImportTXD ( skin, 92 )
    local skin = engineLoadTXD ( "peds/zomb9.txd" ) -- NEW
    engineImportTXD ( skin, 97 )
    local skinDFF = engineLoadDFF ("peds/zomb9.dff", 97 ) -- NEW
    engineReplaceModel (skinDFF, 97);
    local skin = engineLoadTXD ( "peds/zomb8.txd" ) -- NEW
    engineImportTXD ( skin, 105 )
    local skinDFF = engineLoadDFF ("peds/zomb8.dff", 105 )
    engineReplaceModel (skinDFF, 105);
    local skin = engineLoadTXD ( "peds/zomb7.txd" ) -- NEW
    engineImportTXD ( skin, 107 )
    local skinDFF = engineLoadDFF ("peds/zomb7.dff", 107 )
    engineReplaceModel (skinDFF, 107);
    local skin = engineLoadTXD ( "peds/zomb6.txd" ) -- NEW
    engineImportTXD ( skin, 108 )
    local skinDFF = engineLoadDFF ("peds/zomb6.dff", 108 )
    engineReplaceModel (skinDFF, 108);
    local skin = engineLoadTXD ( "peds/zomb5.txd" ) -- NEW
    engineImportTXD ( skin, 111 )
    local skinDFF = engineLoadDFF ("peds/zomb5.dff", 111 )
    engineReplaceModel (skinDFF, 111);
    local skin = engineLoadTXD ( "peds/zomb4.txd" ) -- NEW
    engineImportTXD ( skin, 126 )
    local skinDFF = engineLoadDFF ("peds/zomb4.dff", 126 )
    engineReplaceModel (skinDFF, 126);
    local skin = engineLoadTXD ( "peds/zomb3.txd" ) -- NEW
    engineImportTXD ( skin, 127 );
    local skinDFF = engineLoadDFF ("peds/zomb3.dff", 127 )
    engineReplaceModel (skinDFF, 127);
    local skin = engineLoadTXD ( "peds/zomb2.txd" ) -- NEW
    engineImportTXD ( skin, 128 )
    local skinDFF = engineLoadDFF ("peds/zomb2.dff", 128 )
    engineReplaceModel (skinDFF, 128);
    local skin = engineLoadTXD ( "peds/zomb16.txd" ) -- NEW
    engineImportTXD ( skin, 152 )
    local skinDFF = engineLoadDFF ("peds/zomb16.dff", 152 )
    engineReplaceModel (skinDFF, 152);
    local skin = engineLoadTXD ( "peds/zomb15.txd" ) -- NEW
    engineImportTXD ( skin, 162 )
    local skinDFF = engineLoadDFF ("peds/zomb15.dff", 162 )
    engineReplaceModel (skinDFF, 162);
    local skin = engineLoadTXD ("peds/zomb14.txd" ) -- NEW
    engineImportTXD ( skin, 167 )
    local skinDFF = engineLoadDFF ("peds/zomb14.dff", 167 )
    engineReplaceModel (skinDFF, 167);
    local skin = engineLoadTXD ( "peds/zomb13.txd" ) -- NEW
    engineImportTXD ( skin, 188 )
    local skinDFF = engineLoadDFF ("peds/zomb13.dff", 188 )
    engineReplaceModel (skinDFF, 188);
    local skin = engineLoadTXD ( "peds/zomb12.txd" ) -- NEW
    engineImportTXD ( skin, 192 )
    local skinDFF = engineLoadDFF ("peds/zomb12.dff", 192 )
    engineReplaceModel (skinDFF, 192);
    local skin = engineLoadTXD ( "peds/zomb10.txd" ) -- NEW
    engineImportTXD ( skin, 195 )
    local skinDFF = engineLoadDFF ("peds/zomb10.dff", 195 )
    engineReplaceModel (skinDFF, 105);
    local skin = engineLoadTXD ( "peds/zomb1.txd" ) -- NEW
    engineImportTXD ( skin, 206 )
    local skinDFF = engineLoadDFF ("peds/zomb1.dff", 206 )
    engineReplaceModel (skinDFF, 206);
    local skin = engineLoadTXD ( "peds/ptyzomb.txd" ) -- NEW
    engineImportTXD ( skin, 209 )
    local skinDFF = engineLoadDFF ("peds/ptyzomb.dff", 209 )
    engineReplaceModel (skinDFF, 209);
    local skin = engineLoadTXD ( "peds/rotzomb.txd" ) -- NEW
    engineImportTXD ( skin, 212 )
    local skinDFF = engineLoadDFF ("peds/rotzomb.dff", 212 )
    engineReplaceModel (skinDFF, 212);
    local skin = engineLoadTXD ( "peds/oldzomb.txd" ) -- NEW
    engineImportTXD ( skin, 229 )
    local skinDFF = engineLoadDFF ("peds/oldzomb.dff", 229 )
    engineReplaceModel (skinDFF, 229);
    local skin = engineLoadTXD ( "peds/fzomb.txd" ) -- NEW
    engineImportTXD ( skin, 230 )
    local skinDFF = engineLoadDFF ("peds/fzomb.dff", 230 )
    engineReplaceModel (skinDFF, 230);
    local skin = engineLoadTXD ( "peds/forzomb.txd" ) -- NEW
    engineImportTXD ( skin, 258 )
    local skinDFF = engineLoadDFF ("peds/forzomb.dff", 258 )
    engineReplaceModel (skinDFF, 258);
    local skin = engineLoadTXD ( "peds/fatzomb.txd" ) -- NEW
    engineImportTXD ( skin, 264 ) 
    local skinDFF = engineLoadDFF ("peds/fatzomb.dff", 264 )
    engineReplaceModel (skinDFF, 264);
    local skin = engineLoadTXD ( "peds/ddzomb.txd" ) -- NEW
    engineImportTXD ( skin, 274 )
    local skinDFF = engineLoadDFF ("peds/ddzomb.dff", 274 )
    engineReplaceModel (skinDFF, 274);
    local skin = engineLoadTXD ( "peds/dsczomb.txd" )  -- NEW
    engineImportTXD ( skin, 277 )
    local skinDFF = engineLoadDFF ("peds/dsczomb.dff", 277 )
    engineReplaceModel (skinDFF, 277); ]]
    local skin = engineLoadTXD ( "peds/97.txd" ) -- easterboy by Slothman
    engineImportTXD ( skin, 97 )
    local skin = engineLoadTXD ( "peds/105.txd" ) --Scarred Grove Gangster by Wall-E
    engineImportTXD ( skin, 105 )
    local skin = engineLoadTXD ( "peds/107.txd" ) --ripped and slashed grove by Wall-E
    engineImportTXD ( skin, 107 )
    local skin = engineLoadTXD ( "peds/108.txd" ) -- skeleton thug by Deixell
    engineImportTXD ( skin, 108 )
    local skin = engineLoadTXD ( "peds/111.txd" ) --Frank West from dead rising (nonzombie) by Slothman
    engineImportTXD ( skin, 111 )
    local skin = engineLoadTXD ( "peds/126.txd" ) -- bullet ridden wiseguy by Slothman
    engineImportTXD ( skin, 126 )
    local skin = engineLoadTXD ( "peds/127.txd" ) --flyboy from dawn of the dead by Slothman
    engineImportTXD ( skin, 127 )
    local skin = engineLoadTXD ( "peds/128.txd" ) --holy native by Slothman
    engineImportTXD ( skin, 128 )
    local skin = engineLoadTXD ( "peds/152.txd" ) --bitten schoolgirl by Slothman
    engineImportTXD ( skin, 152 )
    local skin = engineLoadTXD ( "peds/162.txd" ) --shirtless redneck by Slothman
    engineImportTXD ( skin, 162 )
    local skin = engineLoadTXD ( "peds/167.txd" ) --dead chickenman by 50p
    engineImportTXD ( skin, 167 )
    local skin = engineLoadTXD ( "peds/188.txd" ) --burnt greenshirt by Slothman
    engineImportTXD ( skin, 188 )
    local skin = engineLoadTXD ( "peds/192.txd" ) --Alice from resident evil (nonzombie) by Slothman
    engineImportTXD ( skin, 192 )
    local skin = engineLoadTXD ( "peds/195.txd" ) --bloody ex by Slothman
    engineImportTXD ( skin, 195 )
    local skin = engineLoadTXD ( "peds/206.txd" ) -- faceless zombie by Slothman
    engineImportTXD ( skin, 206 )
    local skin = engineLoadTXD ( "peds/209.txd" ) --Noodle vendor by 50p
    engineImportTXD ( skin, 209 )
    local skin = engineLoadTXD ( "peds/212.txd" ) --brainy hobo by Slothman
    engineImportTXD ( skin, 212 )
    local skin = engineLoadTXD ( "peds/229.txd" ) --infected tourist by Slothman
    engineImportTXD ( skin, 229 )
    local skin = engineLoadTXD ( "peds/230.txd" ) --will work for brains hobo by Slothman
    engineImportTXD ( skin, 230 )
    local skin = engineLoadTXD ( "peds/258.txd" ) --bloody sided suburbanite by Slothman
    engineImportTXD ( skin, 258 )
    local skin = engineLoadTXD ( "peds/264.txd" ) --scary clown by 50p
    engineImportTXD ( skin, 264 )
    local skin = engineLoadTXD ( "peds/274.txd" ) --Ash Williams (nonzombie) by Slothman
    engineImportTXD ( skin, 274 )
    local skin = engineLoadTXD ( "peds/277.txd" ) -- gutted firefighter by Wall-E
    engineImportTXD ( skin, 277 )
    local skin = engineLoadTXD ( "peds/280.txd" ) --infected cop by Lordy
    engineImportTXD ( skin, 280 )

    
-- PLAY ZOMBIE music
--local Zx,Zy,Zz = getElementPosition( ped )
--local sound = playSound3D("music/mgroan"..randnum..".ogg", Zx, Zy, Zz, false)
...
statsWindows = guiCreateStaticImage(0.775,0.2,0.225,0.22,"bilder/scrollmenu_1.png",true)
...
function playRandomHitSound () 
    ...
    local sound = playSound("music/hit"..number..".mp3")
end
...
function updateIcons ()
    if getElementData(getLocalPlayer(),"logedin") then
        ...
        --sound
        dxDrawImage ( screenWidth*0.9325 , screenHeight*0.41, screenHeight*0.075, screenHeight*0.075, "bilder/dayzicons/sound.png",0,0,0,tocolor(0,255,0))
        local sound = getElementData(getLocalPlayer(),"volume")/20
        if sound > 1 then
            dxDrawImage ( screenWidth*0.9075 , screenHeight*0.41, screenHeight*0.075, screenHeight*0.075, "bilder/dayzicons/level_"..sound..".png",0,0,0,tocolor(0,255,0))
        end
        --visibly
        dxDrawImage ( screenWidth*0.9325 , screenHeight*0.475, screenHeight*0.075, screenHeight*0.075, "bilder/dayzicons/eye.png",0,0,0,tocolor(0,255,0))
        local sound = getElementData(getLocalPlayer(),"visibly")/20
        if sound > 1 then
            dxDrawImage ( screenWidth*0.9075 , screenHeight*0.475, screenHeight*0.075, screenHeight*0.075, "bilder/dayzicons/level_"..sound..".png",0,0,0,tocolor(0,255,0))
        end
        --brokenbone
        if getElementData(getLocalPlayer(),"brokenbone") then
            dxDrawImage ( screenWidth*0.9375 , screenHeight*0.55, screenHeight*0.065, screenHeight*0.065, "bilder/dayzicons/brokenbone.png",0,0,0,tocolor(255,255,255))
        end
        --bandit    
        ...
        if humanity > 0 then
            ...
            dxDrawImage ( screenWidth*0.925 , screenHeight*0.6, screenHeight*0.1, screenHeight*0.1, "bilder/dayzicons/bandit.png",0,0,0,tocolor(r,g,b))
        --temperature
        ...
        if value > 215 then
            dxDrawImage ( screenWidth*0.94 , screenHeight*0.7, screenHeight*0.065, screenHeight*0.065, "bilder/dayzicons/temperature.png",0,0,0,tocolor(r,g,b,fading))
        else
            dxDrawImage ( screenWidth*0.94 , screenHeight*0.7, screenHeight*0.065, screenHeight*0.065, "bilder/dayzicons/temperature.png",0,0,0,tocolor(r,g,b))
        end
        --thirsty
        r,g,b = 0,255,0
        ...
        if thirst < 15 then
            dxDrawImage ( screenWidth*0.94 , screenHeight*0.775, screenHeight*0.065, screenHeight*0.065, "bilder/dayzicons/thirsty.png",0,0,0,tocolor(r,g,b,fading))
        else
            dxDrawImage ( screenWidth*0.94 , screenHeight*0.775, screenHeight*0.065, screenHeight*0.065, "bilder/dayzicons/thirsty.png",0,0,0,tocolor(r,g,b))
        end    
        --blood
        r,g,b = 0,255,0
        local blood = getElementData(getLocalPlayer(),"blood")/47.2
        r,g,b = 255-blood,blood,0
        dxDrawImage ( screenWidth*0.94 , screenHeight*0.85, screenHeight*0.065, screenHeight*0.065, "bilder/dayzicons/blood.png",0,0,0,tocolor(r,g,b))
        if getElementData(getLocalPlayer(),"bleeding") > 0 then
            dxDrawImage ( screenWidth*0.94 , screenHeight*0.85, screenHeight*0.065, screenHeight*0.065, "bilder/dayzicons/medic.png",0,0,0,tocolor(255,255,255,fading))
        end
        --food
        r,g,b = 0,255,0
        ...
        if food < 15 then
            dxDrawImage ( screenWidth*0.94 , screenHeight*0.925, screenHeight*0.065, screenHeight*0.065, "bilder/dayzicons/food.png",0,0,0,tocolor(r,g,b,fading))
        else
            dxDrawImage ( screenWidth*0.94 , screenHeight*0.925, screenHeight*0.065, screenHeight*0.065, "bilder/dayzicons/food.png",0,0,0,tocolor(r,g,b))
        end    
        --Nametags
        local x,y,z = getElementPosition(getLocalPlayer())
        for i,player in ipairs(getElementsByType("player")) do
...
function showDayZDeathScreen()
    ...
    deadBackground = guiCreateStaticImage(0,0,1,1,"bilder/dead.jpg",true)
...
--OnClientPlayerHit
whiteWindow = guiCreateStaticImage(0,0,1,1,"bilder/white.png",true)
...
--Support Chat
supportWindow = guiCreateStaticImage(0.05,0.25,0.9,0.5,"bilder/scrollmenu_1.png",true)
...
function scoreBoard ()
    ...
    if getElementData(getLocalPlayer(),"logedin") then
        ...
        --Background
        dxDrawImage ( screenWidth*0.15 , screenHeight*0.2, screenWidth*0.7, screenHeight*0.2+yA, "bilder/window_bg.png",0,0,0,tocolor(255,255,255))
        ...
        for i = 1, playerAmount do
            ...
            --dxDrawImage(screenWidth*0.175 , screenHeight*0.2+offset*2+yA-offset2*0.1, screenWidth*0.65, offset2+offset2*0.1,"bilder/background_scoreboard.png", 0,0,0,tocolor(255,255,255,200), false)
            --Position
