...
botSupportTable = {
--Website
{"website","what","","The URL is: www.mtadayz.net.","","James"},
{"website","where","","The URL is: www.mtadayz.net.","","James"},
{"website","which","","The URL is: www.mtadayz.net.","","James"},
{"website","how","","The URL is: www.mtadayz.net.","","James"},
{"website","got","","The URL is: www.mtadayz.net.","","James"},
{"website","know","","The URL is: www.mtadayz.net.","","James"},
--Chat
{"hey","james","","Hey.","","James"},
{"hey","paul","","Yo!.","","Paul"},
...
function funcBindHandsup ( player, key, keyState )
    if handsUp then
        ...
        setPedAnimation (player,"BEACH","ParkSit_M_loop",-1, false, false, nil, false)
        handsUp = true
    end    
end
...
function funcBindSit ( player, key, keyState )
    if siting then
        ...
        if isPedInVehicle (player) then return end
        setPedAnimation (player,"SHOP","SHP_Rob_HandsUp",-1, false, false, nil, false)
        siting = true
    end    
end
